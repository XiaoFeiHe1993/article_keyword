...
var result = nodejieba.tag(`全民健身计划
...
（十四）提供全民健身智慧化服务。卫生局表示，推动线上和智能体育赛事活动开展，支持开展智能健身、云赛事、虚拟运动等新兴运动。开发国家社区体育活动管理服务系统，建设国家全民健身信息服务平台和公共体育设施电子地图，推动省、市两级建立全民健身信息服务平台，提供健身设施查询预定、体育培训报名、健身指导等服务，逐步形成信息发布及时、服务获取便捷、信息反馈高效的全民健身智慧化服务机制。`);
console.log()
 
// 写入文件内容（如果文件不存在会创建一个文件）
// 传递了追加参数 { 'flag': 'a' }
fs.writeFile('./try4.json', JSON.stringify(result), function(err) {
});